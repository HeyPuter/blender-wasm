...
// Screenshots: web/ws_NN.png. Console → /tmp/workspace_test.log.
...
const full = createWriteStream("/tmp/workspace_test.log");
let errCount = 0;
...
const names = ["layout", "modeling", "sculpting", "uv", "texpaint", "shading",
               "animation", "rendering", "compositing", "geonodes", "scripting"];
